...
namespace SEDC.NoteApp.Services.Implementation
{
    ...
    public class UserService : IUserService
    {
        ...
        public string ChangePasswordUser(ChangePasswordUserDto changePasswordUserDto)
        {
            ...
            _userRepository.ChangePassword(userFromDb);

            // Generate a new JWT token with the updated credentials
